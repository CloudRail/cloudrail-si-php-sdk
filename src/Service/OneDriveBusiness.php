...
class OneDriveBusiness implements CloudStorage, AdvancedRequestSupporter
{
	...
	public function __construct(callable $redirectReceiver, string $clientId, string $clientSecret, string $redirectUri, string $state)
	{
		...
		InitSelfTest::initTest('OneDriveBusiness');
		...
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		if (array_key_exists("init",OneDriveBusiness::$SERVICE_CODE)) {
	...
	public function download(string $filePath) {
		Statistics::addCall("OneDriveBusiness", "download");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function upload(string $filePath,  $stream, int $size, bool $overwrite):void {
		Statistics::addCall("OneDriveBusiness", "upload");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function move(string $sourcePath, string $destinationPath):void {
		Statistics::addCall("OneDriveBusiness", "move");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function delete(string $filePath):void {
		Statistics::addCall("OneDriveBusiness", "delete");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function copy(string $sourcePath, string $destinationPath):void {
		Statistics::addCall("OneDriveBusiness", "copy");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, $sourcePath, $destinationPath];
	...
	public function createFolder(string $folderPath):void {
		Statistics::addCall("OneDriveBusiness", "createFolder");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getMetadata(string $filePath):CloudMetaData {
		Statistics::addCall("OneDriveBusiness", "getMetadata");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null, $filePath];
	...
	public function getChildren(string $folderPath):array {
		Statistics::addCall("OneDriveBusiness", "getChildren");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getChildrenPage(string $path, int $offset, int $limit):array {
		Statistics::addCall("OneDriveBusiness", "getChildrenPage");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getUserLogin():string {
		Statistics::addCall("OneDriveBusiness", "getUserLogin");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getUserName():string {
		Statistics::addCall("OneDriveBusiness", "getUserName");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null];
	...
	public function createShareLink(string $path):string {
		Statistics::addCall("OneDriveBusiness", "createShareLink");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getAllocation():SpaceAllocation {
		Statistics::addCall("OneDriveBusiness", "getAllocation");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null];
	...
	public function exists(string $path):bool {
		Statistics::addCall("OneDriveBusiness", "exists");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null, $path];
	...
	public function getThumbnail(string $path) {
		Statistics::addCall("OneDriveBusiness", "getThumbnail");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null, $path];
	...
	public function search(string $query):array {
		Statistics::addCall("OneDriveBusiness", "search");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function login():void {
		Statistics::addCall("OneDriveBusiness", "login");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function logout():void {
		Statistics::addCall("OneDriveBusiness", "logout");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage];
	...
	public function uploadWithContentModifiedDate(string $filePath,  $stream, int $size, bool $overwrite, int $contentModifiedDate):void {
		Statistics::addCall("OneDriveBusiness", "uploadWithContentModifiedDate");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function advancedRequest(AdvancedRequestSpecification $specification):AdvancedRequestResponse {
		Statistics::addCall("OneDriveBusiness", "advancedRequest");
		$ip = new Interpreter(new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function loadAsString($savedState) {
		$sandbox = new Sandbox(OneDriveBusiness::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage);
