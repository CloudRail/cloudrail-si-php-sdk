...
class OneDrive implements CloudStorage, AdvancedRequestSupporter
{
	private static $SERVICE_CODE = [
		'init' => [
			...
			["math.add", '$L1', '$L1', 1],
			["jumpRel", -7],
			["string.indexOf", '$L3', '$P0.scope', "offline_access"],
			["if==than", '$L3', -1, 2],
			["string.concat", '$P0.scope', '$P0.scope', "%20"],
			["string.concat", '$P0.scope', '$P0.scope', "offline_access"],
	...
	public function __construct(callable $redirectReceiver, string $clientId, string $clientSecret, string $redirectUri, string $state, array $scopes=null)
	{
		...
		InitSelfTest::initTest('OneDrive');
		...
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		if (array_key_exists("init",OneDrive::$SERVICE_CODE)) {
	...
	public function download(string $filePath) {
		Statistics::addCall("OneDrive", "download");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function upload(string $filePath,  $stream, int $size, bool $overwrite):void {
		Statistics::addCall("OneDrive", "upload");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function move(string $sourcePath, string $destinationPath):void {
		Statistics::addCall("OneDrive", "move");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function delete(string $filePath):void {
		Statistics::addCall("OneDrive", "delete");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function copy(string $sourcePath, string $destinationPath):void {
		Statistics::addCall("OneDrive", "copy");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, $sourcePath, $destinationPath];
	...
	public function createFolder(string $folderPath):void {
		Statistics::addCall("OneDrive", "createFolder");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getMetadata(string $filePath):CloudMetaData {
		Statistics::addCall("OneDrive", "getMetadata");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null, $filePath];
	...
	public function getChildren(string $folderPath):array {
		Statistics::addCall("OneDrive", "getChildren");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getChildrenPage(string $path, int $offset, int $limit):array {
		Statistics::addCall("OneDrive", "getChildrenPage");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getUserLogin():string {
		Statistics::addCall("OneDrive", "getUserLogin");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getUserName():string {
		Statistics::addCall("OneDrive", "getUserName");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null];
	...
	public function createShareLink(string $path):string {
		Statistics::addCall("OneDrive", "createShareLink");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function getAllocation():SpaceAllocation {
		Statistics::addCall("OneDrive", "getAllocation");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null];
	...
	public function exists(string $path):bool {
		Statistics::addCall("OneDrive", "exists");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null, $path];
	...
	public function getThumbnail(string $path) {
		Statistics::addCall("OneDrive", "getThumbnail");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage, null, $path];
	...
	public function search(string $query):array {
		Statistics::addCall("OneDrive", "search");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function login():void {
		Statistics::addCall("OneDrive", "login");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function logout():void {
		Statistics::addCall("OneDrive", "logout");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
		$auxArray = [$this->interpreterStorage];
	...
	public function uploadWithContentModifiedDate(string $filePath,  $stream, int $size, bool $overwrite, int $contentModifiedDate):void {
		Statistics::addCall("OneDrive", "uploadWithContentModifiedDate");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function advancedRequest(AdvancedRequestSpecification $specification):AdvancedRequestResponse {
		Statistics::addCall("OneDrive", "advancedRequest");
		$ip = new Interpreter(new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage));
	...
	public function loadAsString($savedState) {
		$sandbox = new Sandbox(OneDrive::$SERVICE_CODE, $this->persistentStorage, $this->instanceDependencyStorage);
